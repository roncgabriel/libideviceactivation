...
IDEVICE_ACTIVATION_API_MSC idevice_activation_response_get_field(idevice_activation_response_t response, const char* key, char** value);
IDEVICE_ACTIVATION_API_MSC idevice_activation_response_get_fields(idevice_activation_response_t response, plist_t* fields);
IDEVICE_ACTIVATION_API_MSC idevice_activation_response_get_label(idevice_activation_response_t response, const char* key, char** value);
IDEVICE_ACTIVATION_API_MSC idevice_activation_response_get_placeholder(idevice_activation_response_t response, const char* key, char **value);
